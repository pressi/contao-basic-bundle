...
namespace IIDO\BasicBundle\Controller\Modules;
...
class ArticlenavModule extends Module
{
    /**
     * Template
     * @var string
	...
	public function generate()
	{
		...
		$this->objArticles = ArticleModel::findPublishedByPidAndColumn( $objPage->id, $this->strColumn );
