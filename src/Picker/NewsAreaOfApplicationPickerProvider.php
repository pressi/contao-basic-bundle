...
class NewsAreaOfApplicationPickerProvider extends AbstractPickerProvider implements DcaPickerProviderInterface
{
    /**
    ...
    {
        return 'tl_news_areaOfApplication';
    }
    ...
    public function getUrl(PickerConfig $config)
    {
        ...
        if (\is_array($rootNodes = $config->getExtra('rootNodes')))
        {
            $_SESSION['NEWS_AREA_OF_APPLICATION_ROOT'] = $rootNodes;
        }
        else
            {
            unset($_SESSION['NEWS_AREA_OF_APPLICATION_ROOT']);
        }
    ...
    {
        return 'newsAreaOfApplicationPicker';
    }
    ...
    public function supportsContext($context)
    {
        ...
        return 'newsAreaOfApplication' === $context && ($this->permissionChecker->canUserManageAreaOfApplication() || $this->permissionChecker->canUserAssignAreaOfApplication());
    }
    ...
    {
        return ['do' => 'news', 'table' => 'tl_news_areaOfApplication'];
    }
}
