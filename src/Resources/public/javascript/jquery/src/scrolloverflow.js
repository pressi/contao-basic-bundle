        ...
        _initKeys : function(e) {
            ...
            if( typeof this.options.keyBindings == 'object' )
            {
                for( i in this.options.keyBindings )
                {
                    ...
                    {
                        this.options.keyBindings[ i ] = this.options.keyBindings[ i ].toUpperCase()
                                                                                     .charCodeAt( 0 );
                    }
                }
            }
...
(function(window, $) {
    ...
    window.iscrollHandler = {
        ...
        toggleWheel : function(value) {
            var scrollable = $( SECTION_ACTIVE_SEL )
                .find( SCROLLABLE_SEL );
            scrollable.each( function() {
                var iScrollInstance = $( this )
        ...
        scrollable : function(activeSection) {
            ...
            {
                return activeSection.find( SLIDE_ACTIVE_SEL )
                                    .find( SCROLLABLE_SEL );
            }
        ...
        scrollHeight : function(element) {
            return element.find( SCROLLABLE_SEL )
                          .children()
                          .first()
                          .get( 0 ).scrollHeight;
        },
        ...
        function scrollBarHandler()
        {
            ...
            function createScrollBar(element)
            {
                ...
                else
                {
                    ...
                    {
                        contentHeight = element.find( TABLE_CELL_SEL )
                                               .get( 0 ).scrollHeight;
                    }
                }

                var scrollHeight = $( window )
                    .height() - parseInt( section.css( 'padding-bottom' ) ) - parseInt( section.css( 'padding-top' ) );
            ...
            function removeResponsiveScrollOverflows()
            {
                ...
                forEachSectionAndSlide( function(element) {
                    if( element.closest( SECTION_SEL )
                               .hasClass( AUTO_HEIGHT_RESPONSIVE ) )
                    {
                        scrollOverflowHandler.remove( element );
                    }
                } );
