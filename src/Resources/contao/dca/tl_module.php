...
\IIDO\BasicBundle\Helper\DcaHelper::copyFieldFromTable('inheritColumn', $strFileName, 'inColumn', 'article');

if( !is_array($GLOBALS['TL_DCA'][ $strFileName ]['fields']['inheritColumn']) || (is_array($GLOBALS['TL_DCA'][ $strFileName ]['fields']['inheritColumn']) && count($GLOBALS['TL_DCA'][ $strFileName ]['fields']['inheritColumn'])) )
{
    $GLOBALS['TL_DCA'][ $strFileName ]['fields']['inheritColumn'] = array
    (
