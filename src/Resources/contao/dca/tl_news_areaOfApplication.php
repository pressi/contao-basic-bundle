...
$objTable->addTableButtonsLabel(['new'=>'r Anwendungsbereich'], 'de');
...
// TABLE CONFIG
$objTable->addTableConfig('label', 'Anwendungsbereich');
//$objTable->addTableConfig('backlink', 'do=news&table=tl_news&id=' . Input::get('id'));
